...
async function getInputValue(){
  ...
  if(value === "all"){
    ...
    trueValue(value);
    createText("Hello , My name is Akhil and I'm a Research Associate")
    createText("My works and skills are included in the fields of Machine Learning, Deep Learning, Natural Language Processing, DevOps")
  }
